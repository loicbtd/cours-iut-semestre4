...
//            }
//        };
//        IntentFilter intentFilter = new IntentFilter(getString(R.string.key_restaurant_intent));
//        getContext().registerReceiver(broadcastReceiver, intentFilter);
//
//        BestRestaurantAsyncTask bestRestaurantAsyncTask = new BestRestaurantAsyncTask(getContext(), new LatLng(47.6397, 6.8638));
