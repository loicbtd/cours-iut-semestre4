...
//    private ChraracterListAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //        HERE DETERMINE IF IT IS THE FIRST TIME THAT THE ACTIVITY IS OPENED
        SharedPreferences sharedPreferences = getContext().getSharedPreferences("is_first_time", 0);
        if (sharedPreferences.getBoolean("is_first_time", true)) {
            Character c1, c2, c3;
            try {
                c1 = new Character(1, "Jean-François", "Couchot", "http://members.femto-st.fr/jf-couchot/fr", 47.642900f, 6.840027f, "couchot");
                c2 = new Character(2, "Raphaël", "Couturier", "http://members.femto-st.fr/raphael-couturier/fr", 47.659518f, 6.813337f, "couturier");
                c3 = new Character(3, "Stéphane","Domas", "http://info.iut-bm.univ-fcomte.fr/staff/sdomas/", 47.6387143f, 6.8370225f, "domas");
